	...
	<script>
		$(function () {
			/* $(".registerrighttracingareabutton1").click(function(){
				if($(".popuplastarea").css('display') == 'none'){
					$(".popuplastarea").show();
				}else{
					$(".popuplastarea").hide();					
				}
			...
			$(".registerrighttracingareabutton2").click(function(){
				if($(".popupaddress").css('display') == 'none'){
					$(".popupaddress").show();
				}else{
					$(".popupaddress").hide();					
				}
...
<!-- ------------------------------------------------------------------------------------------------------------------------------ -->
	<div class= "container">
		...
		<form action = "Controller?command=ProductRegist" class="basicinfomation" enctype="multipart/form-data" method = "post">
						...
						<div class="registerright">
							<div class="registerrightproductname">
								<div class="registerright registerrightproductnameleft">
									<input type="text" placeholder="상품 제목을 입력해주세요." class="registerrightproductnamelefttextbar" style ="height: 3rem; pedding: 0px 1rem;" name = "productname">
	...
	<!-- -------------------------------------------추가 작업 필요------------------------------------------------------------------------------------------ -->
					...
					<li class= "register">
						...
						<div class="registerright">
							...
							<input readonly placeholder="선호 거래 지역을 검색해주세요." name = "tradingarea" class="registerrighttracingareatextbar" value="지역설정안함">
					...
					<li class= "register">
						...
						<div class="registerright">
							<div class="registerrightpricecast">
								<input type ="text" placeholder ="숫자만 입력해주세요." class ="registerrightpricetextbar" name = "price">
								원
							</div>
							<div class="registerrightpricedelivery">
								<label class="registerrightpricedeliverycheck">
									...
									<input type = "hidden" id = "hiddencheck" name = "deliverycharge" value="배송비별도">
								</label>
							</div>
						</div>
					</li>
					<li class= "register">
						...
						<div class="registerright">
							<input type = "text" placeholder="상품 설명을 입력해주세요. (10글자 이상)" rows="6" class="registerrightinform" name = "productinformation">
							...
							<div class="registerrighttagcast">
								<div class="registerrighttag">
									<div class="registerrighttagshape">
										<input type="text" placeholder ="연관태그를 입력해주세요. (최대  5개)" name = "tag">
									</div>
								</div>
							</div>
					...
					<li class= "register">
						...
						<div class="registerright">
							<div class="registerrightquantity">
								<input type="text" class="registerrightquantitytextbar" name = "quantity">
								개
							</div>
						</div>
					</li>
				...
				<input type = "hidden" name = "safety_payment" value="N">
				<!-- <div class="section1 section2">
			...
			<footer class="footermain">
				<div class="footercast">
					<input type="submit" class="footerbutton" value ="등록하기">
					<ul></ul>
				</div>
			</footer>
			</form>
