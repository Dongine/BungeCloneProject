...
<head>
	...
	<%
		...
		String dealDate = (String)(request.getAttribute("dealDate"));
			...
			<div id="dealCheckCt1_1">
				...
				<div id="dealCheckCt4">
					...
					<div id="dealCheckCt4_1">
						<span id="dealCompletedDirect">거래완료</span>
				...
				<div id="dealCheckCt5">
					<div id="dealCheckCt5_1">
						<p id="dealCheckCt5_1_1">거래완료일</p>
						<span style="color: #212121;"><%=dealDate%></span>
					</div>
					...
					<div id="dealCheckCt5_3">
						...
						<div>
							<p style="margin: 0; color: #212121;"><span><%=sellerFk%></span>&nbsp;:&nbsp;<span><%=sellerPhoneNumber%></span></p>
							<p style="margin: 0; color: #212121;"><span><%=consumerFk%></span>&nbsp;:&nbsp;<span><%=consumerPhoneNumber%></span></p> 
						</div>
					</div>
				</div>
